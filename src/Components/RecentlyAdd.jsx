  ...
  return (
    <div className="relative    border-2 border-[#424242] space-y-20 bg-[#2E2D2E] px-28 py-10   text-white  max-w-[1229px]  mx-auto   rounded-[60px]">
      <div className="flex flex-col gap-2 ">
        <p className="text-4xl leading-7 font-bold">Recently Add.</p>
      </div>
      <div className="flex gap-4">
        <div className="relative">
          <div className="absolute top-2 right-2 w-10 h-10 bg-[#0851DF] rounded-full  flex items-center justify-center ">
      ...
      {/* <div className="relative rounded-[100px]    border-[#0851DF] z-50 h-[600px] w-[500px] bg-bayra-story bg-center bg-cover ">
